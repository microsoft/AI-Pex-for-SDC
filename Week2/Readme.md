...
After selecting a prioritized use case, it is time to decide how to develop it. SDCs can choose from three main approaches: extend or adopt a Microsoft Copilot, build a custom copilot, or create an application on Fabric. Learn more in this article: [Creating Generative AI Experiences with the Microsoft Cloud: A Guide for SDC/ISVs](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/isv-extensibility-story).
...
- Online Learning Events:
  - [Online Event for SDC/ISV](https://events.microsoft.com/en-us/allevents/?clientTimeZone=1&search=Envisioning)
> **Note**: If you are unable to view the downloaded materials, please contact your Microsoft representative.
